...
#[dbus_proxy(interface = "com.dosbox", default_service = "com.dosbox", default_path = "/cpu")]
trait Cpu {
	#[dbus_proxy(name = "get")]
...
#[dbus_proxy(interface = "com.dosbox", default_service = "com.dosbox", default_path = "/mem")]
trait Memory {
	#[dbus_proxy(name = "get")]
